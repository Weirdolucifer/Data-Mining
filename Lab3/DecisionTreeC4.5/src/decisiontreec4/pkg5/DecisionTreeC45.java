...
public class DecisionTreeC45 
{
    ...
    ArrayList<Double> splitatt=new ArrayList<Double>();
    //int visit[]=new int[7];
    ...
    void run()
    {
          ...
          /*cntv=4;
          getInput("elec.txt");
          StoreAtt.add("age");StoreAtt.add("income");
          StoreAtt.add("student");StoreAtt.add("credit_rating");
          attributes.put("age",0);attributes.put("income",1);
          attributes.put("student",2);attributes.put("credit_rating",3);*/
          ...
          att=InfoAndSplitInfoForAllAttributes(DTree.table);
          ...
          //System.out.println("["+DTree.attribute+"]");
         ...
         // System.out.println(DTree.value);
          queue.add(DTree);
          bfs();
    ...
    void bfs()
    {
           while (queue.peek() != null) 
           {
                 ...
                 {
                       //System.out.println(attributes.get(ParentNode.attribute));
                       ...
                       else
                       {
                           ...
                           lables=hsp;
                           splitatt.clear();
                           attri=InfoAndSplitInfoForAllAttributes(child.table);
                           double x=-112.00;
                            //System.out.println(x);
                           int index=-1;
    ...
    ArrayList<Double> InfoAndSplitInfoForAllAttributes(ArrayList<ArrayList<String>> data)
    {
          ...
          {   
               ...
               for(String st : mp.keySet())
               {
                    ...
                    double va;
                    va=(double)mp.get(st)/(double)data.size();
                    sumx+=va*(Math.log(va)/Math.log(2));
                    Ind.put(st,x);
                    x++;
               }
